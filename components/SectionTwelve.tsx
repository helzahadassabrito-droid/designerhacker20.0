...
const PainPointCard: React.FC<{ text: string }> = ({ text }) => {
  return (
    <TechCard className="h-full min-h-[220px]">
        <div className="flex flex-col gap-6 p-8 md:p-10 h-full">
            {/* Icon Box */}
            <div className="w-14 h-14 rounded-xl bg-[#00CBD9]/10 border border-[#00CBD9]/20 flex items-center justify-center group-hover:bg-[#00CBD9]/20 group-hover:border-[#00CBD9]/50 group-hover:shadow-[0_0_20px_rgba(0,203,217,0.4)] transition-all duration-300 relative overflow-hidden shrink-0">
